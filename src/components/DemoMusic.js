...
//               {
//                 name: "test",
//                 musicSrc: "http://podcasts.protocol-radio.com/podcast/protocol-radio-331.m4a",
//               },
//             ]);
//           }}
//         >
...
//             quiet update audio list (don't interrupt current play state) ({audioList3.length})
//           </button>
//           <button type="button" onClick={this.onQuietUpdateAudioLis2}>
//             quiet update audio list (current playing audio not in updated list) ({audioList4.length})
//           </button>
...
//           </label>
//           <label htmlFor="drag">
//             <input type="checkbox" id="drag" checked={params.drag} onChange={this.onDrag} />
//             drag
//           </label>
//           <label htmlFor="seeked">
//             <input type="checkbox" id="seeked" checked={params.seeked} onChange={this.onSeeked} />
//             seeked
//           </label>
//           <label htmlFor="toggle">
//             <input type="checkbox" id="toggle" checked={params.toggleMode} onChange={this.onToggleMode} />
//             toggleMode
//           </label>
//           <label htmlFor="autoPlay">
//             <input type="checkbox" id="autoPlay" checked={params.autoPlay} onChange={this.onAutoPlayMode} />
//             autoPlay
//           </label>
...
//             <input type="checkbox" id="preload" checked={params.preload} onChange={() => this.onChangeKey("preload")} />
//             preload
//           </label>
//           <label htmlFor="remove">
//             <input type="checkbox" id="remove" checked={params.remove} onChange={() => this.onChangeKey("remove")} />
//             remove
//           </label>
